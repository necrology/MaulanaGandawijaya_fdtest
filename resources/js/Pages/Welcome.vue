...
const filteredBooks = computed(() => {
    return props.books.filter((book) => {
        const matchesAuthor = authorFilter.value
            ? book.author
                  .toLowerCase()
                  .includes(authorFilter.value.toLowerCase())
            : true;
        const bookDate = new Date(book.created_at).toISOString().split("T")[0];
        const matchesDate = dateFilter.value
            ? bookDate === dateFilter.value
            : true;
        const matchesRating = ratingFilter.value
            ? book.rating === Number(ratingFilter.value)
            : true;

        return matchesAuthor && matchesDate && matchesRating;
    });
});
        ...
        >
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                ...
                >
                    ...
                    <div class="flex lg:col-start-2 lg:justify-center">
                        <h1 class="text-2xl font-semibold text-right mt-3">
                            Filter by :
                        </h1>
                    </div>
                    ...
                    <div class="flex lg:col-start-3 lg:justify-center">
                        <input
                            v-model="dateFilter"
                            type="date"
                            class="border p-2 rounded w-full"
                                ...
                                >
                                    ...
                                    >
                                        <div class="pt-3 sm:pt-5 lg:pt-0">
                                            ...
                                            <h2
                                                class="mt-1 font-semibold text-black dark:text-white"
                                            >
                                                Author : {{ book.author }}
                                            </h2>
