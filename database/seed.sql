...
VALUES
  ...
  (85, 'pm12-po-dashboard.png', 'pm12-po-dashboard.png', '/uploads/project/pm12-po-dashboard.png', 'image/png', 108458, 'project', 'project', 12),
  (86, 'pm12-po-list.png', 'pm12-po-list.png', '/uploads/project/pm12-po-list.png', 'image/png', 98221, 'project', 'project', 12),
  (87, 'pm12-po-log-approval.png', 'pm12-po-log-approval.png', '/uploads/project/pm12-po-log-approval.png', 'image/png', 114481, 'project', 'project', 12),
  (88, 'pm13-crm-dashboard.png', 'pm13-crm-dashboard.png', '/uploads/project/pm13-crm-dashboard.png', 'image/png', 53513, 'project', 'project', 13),
  (89, 'pm13-crm-table.png', 'pm13-crm-table.png', '/uploads/project/pm13-crm-table.png', 'image/png', 91288, 'project', 'project', 13),
  (90, 'pm13-crm-forecast.png', 'pm13-crm-forecast.png', '/uploads/project/pm13-crm-forecast.png', 'image/png', 44261, 'project', 'project', 13),
  (91, 'pm13-crm-top-outlet.png', 'pm13-crm-top-outlet.png', '/uploads/project/pm13-crm-top-outlet.png', 'image/png', 47692, 'project', 'project', 13),
  (92, 'pm14-lnd-dashboard.png', 'pm14-lnd-dashboard.png', '/uploads/project/pm14-lnd-dashboard.png', 'image/png', 24191, 'project', 'project', 14),
  (93, 'pm15-posevt-dashboard.png', 'pm15-posevt-dashboard.png', '/uploads/project/pm15-posevt-dashboard.png', 'image/png', 28379, 'project', 'project', 15),
  (94, 'pm16-security-assessment-overview.png', 'pm16-security-assessment-overview.png', '/uploads/project/pm16-security-assessment-overview.png', 'image/png', 107567, 'project', 'project', 16),
  (95, 'pm16-security-assessment-findings.png', 'pm16-security-assessment-findings.png', '/uploads/project/pm16-security-assessment-findings.png', 'image/png', 108143, 'project', 'project', 16),
  (96, 'pm16-security-assessment-remediation.png', 'pm16-security-assessment-remediation.png', '/uploads/project/pm16-security-assessment-remediation.png', 'image/png', 108482, 'project', 'project', 16),
